    ...
    <main className="min-h-screen bg-gray-950 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-1">Start breaking language barriers today</p>
        </div>
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="text-gray-400 text-sm font-medium block mb-2">Preferred Language</label>
              <select
            ...
            <div className="flex items-center gap-3 bg-gray-800 rounded-xl px-4 py-3 border border-gray-700">
              <input
                ...
                id="isDeaf"
                checked={form.isDeaf}
                onChange={(e) => setForm({ ...form, isDeaf: e.target.checked })}
                className="w-4 h-4 accent-indigo-500"
              />
              <label htmlFor="isDeaf" className="text-gray-300 text-sm">
